...
describe("PortfolioCalculator", () => {
  ...
  const emergingFund: Position = {
    id: "em", name: "Fidelity Emerging Markets", ticker: "0P0000KSP9.F",
    type: "fondo", units: 5, price: 10, group: "rv",
  };
  ...
  const emptyPosition: Position = {
    ...
    type: "fondo", units: 0, price: 15, group: "rv",
  };
  ...
  it("should compute equityWeightOf as the percentage a given equity position represents within equity", () => {
  ...
  it("should return 0 from equityWeightOf for a position id that is not part of the portfolio", () => {
    const derived = new PortfolioCalculator().derive([worldFund]);
