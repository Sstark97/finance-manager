...
export function Metric({ label, value, sub, valueColor }: MetricProps): React.JSX.Element {
  return (
    <div>
      ...
      <div className="num" style={{ fontSize:22, fontWeight:600, color: valueColor }}>{value}</div>
